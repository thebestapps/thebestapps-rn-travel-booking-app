    ...
    render(){
        return(
            <SafeAreaView style={{flex: 1}}>
                <Modal animationInTiming={800} isVisible={this.state.optionsModal} style={{height:windowHeight, flex: 1, width: "100%", justifyContent:"center", alignSelf:"center"}} backdropOpacity={0.8} useNativeDriver={true}>
                    <View>
                                ...
                                :
                                    <View style={{paddingHorizontal: "4%"}}>
                                        ...
                                        <TouchableOpacity onPress={() => this.setState({datePicker: true})}>
                                                <Text style={{fontSize: 14.5, color:"black", paddingLeft: 1, marginTop: 4, marginBottom: 4}}>1/9</Text>
                                        </TouchableOpacity>
                                        {
